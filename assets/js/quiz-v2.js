var QUIZ_BANK = [
  ...
  { module: "clearance", q: "60335-1 表16 中加强绝缘的电气间隙如何取值？", options: ["按基本绝缘 2 倍", "用下一档冲击电压（2500V 基本 → 4000V 档）", "与基本绝缘相同", "减半"], answer: 1, explain: "表16：加强绝缘按下一个更高额定脉冲电压档取值（如 2500V 基本 1.5mm → 4000V 档 3.0mm）；爬电才是 2×。" },
  ...
  { module: "shock", q: "II 类设备的防触电不依赖下列哪一项？", options: ["双重绝缘", "保护接地", "加强绝缘", "基本绝缘 + 附加绝缘"], answer: 1, explain: "II 类设备不依赖保护接地，靠双重/加强绝缘保证安全；I 类才依赖接地。" },
  { module: "shock", q: "需要工具才能打开的盖板，通常如何判定？", options: ["属于可触及部件", "不作为可触及部件判定", "一定绝对安全", "必须再加绝缘"], answer: 1, explain: "需要工具拆卸的部件一般不作为可触及部件，但“工具”的定义与可拆卸部件判定以产品标准为准。" },
  { module: "shock", q: "防触电五道防线中，最优先采用的是？", options: ["外壳隔离", "保持距离", "限制电压（SELV）", "保护元件"], answer: 2, explain: "能限压就先限压，SELV 从源头消除危险；其他手段是距离/绝缘/元件/外壳兜底。" },
