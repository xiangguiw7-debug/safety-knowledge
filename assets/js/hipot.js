var HIPOT_DATA = {
  ...
  "60204": {
    ...
    label: "IEC 60204-1（机械电气）：试验电压 = 2 × Un + 1000V（Un = 额定电压，230V 时 ≈ 1500V）"
  },
  "60598": {
    basic: 1500, supplementary: 1500, reinforced: 3000,
    label: "IEC 60598-1 / GB 7000.1（灯具）：基本/附加绝缘 = 2U + 1000V，加强绝缘 = 4U + 2000V（U = 额定工作电压，230V 时 ≈ 1500V / 3000V）"
  },
  "61347": {
    basic: 1500, supplementary: 1500, reinforced: 3000,
    label: "IEC 61347-1 / GB 19510（灯控制装置/驱动）：基本/附加绝缘 = 2U + 1000V，加强绝缘 = 4U + 2000V（U = 额定工作电压，230V 时 ≈ 1500V / 3000V）"
  }
};
